...
try {
	...
	if (c) {
		...
		rtc =  new Array();
rtc[0] = [19998, 'http://r.casalemedia.com/rum?cm_dsp_id=65&external_user_id=USERTOKEN', 7];	// 
rtc[1] = [14000, 'http://cm.g.doubleclick.net/pixel?dtm_ghm&google_nid=dotomi&google_sc&google_ula=17128&google_hm=USERTOKEN ', 7];	// 
rtc[2] = [80426, 'http://sync.search.spotxchange.com/partner?adv_id=7183&img=1&uid=USERTOKEN', 7];	// 
rtc[3] = [12783, 'http://pixel.rubiconproject.com/tap.php?v=5364|1|90&nid=2046&expires=90&put=USERTOKEN', 7];	// 
rtc[4] = [17100, 'http://image2.pubmatic.com/AdServer/Pug?vcode=bz0yJnR5cGU9MSZjb2RlPTQ2MSZ0bD0xNTc2ODAw&piggybackCookie=USERTOKEN', 7];	// 
rtc[5] = [14200, 'http://bh.contextweb.com/bh/rtset?do=add&pid=530912&ev=USERTOKEN', 7];	// 
rtc[6] = [12401, 'http://sync.rhythmxchange.com/usersync/conversant/USERTOKEN', 7];	// 
rtc[7] = [3435, 'http://www.facebook.com/fr/u.php?p=282726141853322&m=USERTOKEN', 7];	// 
rtc[8] = [3110, 'http://t4.liverail.com/?metric=csync&p=3011&s=USERTOKEN', 7];	// 
rtc[9] = [60, 'http://ums.adtechus.com/mapuser?providerid=1013;userid=USERTOKEN', 7];	// 
